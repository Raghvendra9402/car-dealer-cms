      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-8xl sm:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            ultimate driving experience at unbeatable prices.
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden pt-16 -mb-16 sm:-mb-24 xl:mb-0">
        <div
          className="mx-auto max-w-7xl h-75 bg-cover bg-no-repeat bg-center xl:rounded-t-xl shadow-2xl"
          style={{
            backgroundImage: `url("https://wallpapercave.com/wp/wp3978463.jpg")`,
          }}
        />
